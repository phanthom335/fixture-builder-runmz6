...
from pathlib import Path
        ...
        APP_NAME    = "Fixture Builder Runmz6"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Data engineering tool to parse structured datasets with zero hassle.")
